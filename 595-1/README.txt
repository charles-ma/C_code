...
3.Tests for question 1 and 2 will output the content of the array; test for question 3 should output a sorted array; test for question 4 should output a sorted linked list; 
