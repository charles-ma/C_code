...
The content of the script is simple numbers, every four numbers form a group indicating a move. eg, 6152 means move a piece from (6, 1) to (5, 2). You'd better make sure the moves in the script are legal, or there would be something unexpected. And the script will contain moves for both sides, they appear in turn.
